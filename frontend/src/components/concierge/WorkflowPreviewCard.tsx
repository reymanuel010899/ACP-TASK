...
export default function WorkflowPreviewCard({ workflow, onDecision }: { workflow: WorkflowPreview; onDecision?: (approved: boolean) => void }) {
  ...
  return <section aria-label="Workflow preview" className="rounded-xl border border-violet-500/30 bg-[var(--ag-card)] p-4">
    <p className="text-xs font-semibold uppercase tracking-wide text-violet-400">Plan listo para revisar · revisión {workflow.revision}</p>

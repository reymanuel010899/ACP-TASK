import EcosystemNetworkCanvas from "@/components/dashboard/EcosystemNetworkCanvas";

export default function EcosystemNetwork() {
  return (
    <div
      className="box-border w-full h-fit shrink-0 flex flex-col gap-0 justify-start items-start bg-[var(--ag-card)] [border:1px_solid_var(--ag-card-border)] rounded-[12px] overflow-hidden"
    >
      <div
        className="box-border w-full h-fit shrink-0 flex flex-row gap-0 p-[16px_20px] justify-between items-center"
      >
        <div
          className="box-border w-fit shrink-0 h-fit flex flex-col gap-[4px] justify-start items-start"
        >
          <div
            className="text-[18px]/[normal] box-border text-[var(--ag-text)] font-[Inter,system-ui,sans-serif] font-bold text-left [white-space:nowrap]"
          >
            Ecosystem Network
          </div>
          <div
        ...
        <div
          className="box-border w-fit shrink-0 h-fit flex flex-row gap-[6px] p-[6px_12px] justify-start items-center bg-[var(--ag-input-bg)] [border:1px_solid_var(--ag-card-border)] rounded-[6px]"
        >
          <div
